...
typedef struct
{
	uint8_t Frame_Update_flag;
	uint8_t Operate_Update_flag;

	/**
	 * @brief  the flag of graphic operate
	 *         1: ADD
	 *         2: MODIFY
	 */
	Graphic_Operate_e graphic_operate;
	uint8_t CliendTxBuffer[200];
}UI_FRAME_INFO_Typedef;


extern void UI_FrameInfo_Update(void);
